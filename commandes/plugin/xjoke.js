...
const ping = async (m, sock) => {
  ...
  if (cmd === "speed") {
    ...
    // Updated text style with HUNTER-MD-BOT branding and response rate
      ...
      m.from,
      {
        ...
        contextInfo: {
          ...
          externalAdReply: {
            ...
            body: "Ping speed calculations",
            thumbnailUrl: 'https://raw.githubusercontent.com/WISDOMHUNTER01/HUNTER-MD-BOT-/refs/heads/main/media/menu.jpg', // Thumbnail URL
      ...
      sock.sendMessage(
        m.from,
        {
          ...
          contextInfo: {
            ...
            externalAdReply: {
              title: "HUNTER-MD-BOT v1.0",
              body: "Here’s a joke to make you laugh",
              thumbnailUrl: 'https://raw.githubusercontent.com/WISDOMHUNTER01/HUNTER-MD-BOT-/refs/heads/main/media/menu.jpg', // Thumbnail URL
              sourceUrl: 'https://whatsapp.com/channel/0029Vak2PevK0IBh2pKJPp2K', // Source URL if necessary
              mediaType: 1,
              renderLargerThumbnail: false,
